...
<table class="orderLsit" style="width:900px; margin:auto; border-top: 2px solid #214d0d;margin-top:50px; ">
	<tr>
		<th width="60%">상품 내역</th> <th>가 격</th> <th>주문일</th> <th>진행 상태</th>
	</tr>	
	<c:forEach var="order" items="${order}" >
	<tr style="border-bottom:1px solid darkgrey;">
		<td ><a href="order_detail.do?oseq=${order.oseq}" style="color:#d93240">${order.pname}</a></td> 
...
<!-- 	<th colspan="2"> 총 액</th> -->
<%-- 	<th colspan="2" style="text-align:left"><fmt:formatNumber value="${totalPrice}" type="currency"/> </th>  --%>
<!-- 	<th></th> -->
<!-- 	</tr> -->
