...
<form action="QnA_update.do?qseq=${qna.qseq}" method="post">
...
<table class="qna">
	...
	<tr>
		...
		<c:out value="${qna.content}"></c:out></textarea>
		</div>
		</td>
	</tr>
	<tr>
		...
		<input type='button' value='취소' style="background : white ; color : #214d0d; 
				width : 60px; height : 30px; border:2px solid #214d0d; font-size:16px; outline:none;" onclick="location.href='QnA.do'">
