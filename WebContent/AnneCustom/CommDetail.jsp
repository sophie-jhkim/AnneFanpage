...
<table class="board">
	...
	<tr>
		 ...
		 <span><fmt:formatDate value="${board.indate}" type="date"/>  조회 ${board.hit}  <span style="text-indent:10px">작성자: ${mania.nick}</span></span>
		 <c:choose>
...
<form action="../AnneCustom/breply_insert.do" method="post" name="reply">
...
<table class="reply">
	...
	<tr style="border-bottom: 1px solid grey; ">
		...
		<input type="hidden" value="${rep.bseq}" name="bseq">
...
<%-- 			<input type='button' value='수정' onclick="location.href='../AnneCustom/breply_update.do?rseq=${rep.rseq}'" style=""> --%>
	...
	<tr>
		...
		<td colspan="3">
		<textarea rows="4" name="content" cols="80" style="font-size: 16px; border:1px solid grey;font-family: 'Noto Sans KR', sans-serif;" name="reply" ></textarea> </td>
...
<!-- <td style="vertical-align:middle;"><input type="button" value="등록" onclick="location.href='../AnneCustom/breply_insert.do'" -->
