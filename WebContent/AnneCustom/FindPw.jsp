...
<form method="post" name="form" action="../AnneCustom/findPw.do">
<h3>패스워드 찾기</h3>
...
<tr>
<th>ID :</th>
<td><input type="text" name="id" style="border-bottom:1px solid grey;"> 
</tr>
<tr>
<th>E-mail :</th>
...
%>
<div>고객님의 패스워드는 <span><%= mania.getPwd()%></span> 입니다.<br>
<input type="button" value="닫기" onclick="window.close()" class="button"/></div>

<%}else{ %>
<div> 해당하는 고객 정보가 없습니다. <br>
<input type="button" value="재시도" onclick="findPw()" class="button"/>
